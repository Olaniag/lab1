...
print("Nazywam si� Aleksandra Glapiak. M�j login na Githubie to Olaniag. Tematem pracy magisterskiej jest analiza dok�adno�ci aerotriangulacji zdj�� pozyskanych z wykorzystaniem drona, w szczeg�lnych warunkach kopali.")
print("Wed�ug mnie, kod zawiera informacje o u�ytkownikach, dodatkowo w kodzie utworzone zosta�y funkcje do obliczenia op�aty, wyszukiwanie najbli�szego s�siada oraz zwraca rekomendacje na podstawie innych u�ytkownik�w")
